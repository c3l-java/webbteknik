...
var i = 0,
    currentUser, isYoungSuperUser;
for (i = 0; i < users.length; i = i + 1) {
    currentUser = users[i];
    isYoungSuperUser = (currentUser.accessLevel > 3 && currentUser.age < 20);
    if (currentUser.authenticated && (currentUser.administrator || isYoungSuperUser)) {
